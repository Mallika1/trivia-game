...
var q4 = {
	...
	options: ['Jack Ma','Joseph TSai','Peng Li','Robin Li'],
	rightAnswer: 'Jack Ma',
...
var qa4 = {
	...
	options: ['Brazil','Argentina','Nepal','Japan'],
	rightAnswer: 'Nepal',
	image:'<img src="assets/images/everest.jpg" id="image">',
	description:'<div id="description">Mount Everest is Earth\'s highest mountain above sea level, located in the sub-range of the Himalayas. </div>'
};
var qa5 = {
